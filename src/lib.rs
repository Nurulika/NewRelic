// src/lib.rs
/*
 * Core library for NewRelicAgent
 */
...
#[derive(Debug)]
pub struct NewRelicAgentProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NewRelicAgentProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NewRelicAgent processing");
    
    let mut processor = NewRelicAgentProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NewRelicAgentProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NewRelicAgentProcessor::new(false);
